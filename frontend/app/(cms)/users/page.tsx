...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AddTeacherModal open={openTeacher} onClose={() => setOpenTeacher(false)} onSuccess={fetchUsers} />
      <AddStudentModal open={openStudent} onClose={() => setOpenStudent(false)} onSuccess={fetchUsers} />
    </div>
  )
}